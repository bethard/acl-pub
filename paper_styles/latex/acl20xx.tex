...
% File acl20xx.tex
%
\pdfoutput=1	% must be in first 5 lines to tell arxiv to use pdflatex
%		% hyperref doesn't look good with dvi-producing latex
%
...
%\bibliography{anthology,acl20xx}
\bibliography{acl20xx}
